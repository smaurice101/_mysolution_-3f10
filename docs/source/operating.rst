[_mysolution_-3f10] Operating Details
====================================

Generated On: 2025-02-11 03:42:10 UTC
...
.. important::
   ...
   **not be valid if your [_mysolution_-3f10] container is NOT running**.

.. tip::
   You must have your [_mysolution_-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   maadsdocker/_mysolution_-3f10-amd64 (https://hub.docker.com/r/maadsdocker/_mysolution_-3f10-amd64)
...
.. code-block::
   ...
   docker run -d -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=_mysolution_-3f10 \
          ...
          maadsdocker/_mysolution_-3f10-amd64
...
[_mysolution_-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/_mysolution_-3f10
...
.. important::
   https://_mysolution_-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-elastalink-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44433, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39229, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33341, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33935, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45853, HPDEHOST=127.0.1.1, HPDEPORT=45669, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40855

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2120-_mysolution_-3f10,solution_preprocessing_dag-elastalink-3f10, python-preprocess-3392-_mysolution_-3f10,solution_preprocessing_dag-elastalink-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
